...
import { applyColorOverlay, getActiveBgLayer } from './100-cover-background.js';
...
function applyBackgroundSettings() {
            ...
            if (b.dynamicBg) {
                layers.forEach(bg => {
                    bg.style.filter = `blur(${b.blur}px) brightness(${b.brightness})`;
                    /* 仅当前活动层保持可见，非活动层保持隐藏 */
                });
